 ...
 */
public abstract class AbstractAdvancedPerksEvent extends Event {

    private static final HandlerList HANDLERS = new HandlerList();
    private final Player player;
    private final String perkId;

    protected AbstractAdvancedPerksEvent(Player player, String perkId) {
        this.player = player;
        this.perkId = perkId;
    }

    protected AbstractAdvancedPerksEvent(Player player, String perkId, boolean async) {
        super(async);
        this.player = player;
        this.perkId = perkId;
    }
 ...
 */
class PerkEnabledEvent extends AbstractAdvancedPerksEvent implements Cancellable {
 ...
 */
class PerkDisabledEvent extends AbstractAdvancedPerksEvent implements Cancellable {
 ...
 */
class PerkPurchasedEvent extends AbstractAdvancedPerksEvent {
